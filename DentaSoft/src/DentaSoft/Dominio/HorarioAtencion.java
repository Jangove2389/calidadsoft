...
public class HorarioAtencion {
    ...
    public HorarioAtencion(String idhorario, LocalTime horaInicio, LocalTime horaFin, String estado, Dentista dentista) {
    ...
    public String getHoraInicioFinFormato() {
        return String.format("%s - %s", horaInicio.toString(), horaFin.toString());
    }
