...
public class Cita {
    ...
    public Cita(int idcita, String detallecita, double preciocita, double pagototal, Dentista dentista, Paciente paciente, HorarioAtencion horarioatencion, LocalDate fecha, String tipocita, double descuentototal) {
        this.idcita = idcita;
