...
public class VentanaRegistrarPaciente extends javax.swing.JDialog {
    ...
    private void validarEntero(JTextField txt, String mensaje) throws java.lang.Exception {
        try {
    ...
    private void validarNombre(JTextField txt) throws java.lang.Exception {
        try {
            ...
            if (!txt.getText().matches("[a-zA-Z\\s]*")) {
                throw new Exception("El nombre no debe contener caracteres numéricos.");
            }
        } catch (Exception e) {
            txt.requestFocus();
            txt.selectAll();
    ...
    private void validar() throws Exception {
        validarNombre(txtNombres);
        validarEntero(txtEdad, "Ingrese edad válida");
        validarDNI(txtDni);
