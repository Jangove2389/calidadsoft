...
public class CitaPostgreSQL {
    ...
    public void guardar(Cita cita) throws Exception {
        String insertSQL = "insert into cita(detallecita, preciocita, iddentista, idpaciente, idhorario,fecha,pagototal,tipocita,descuentototal)"
                + "values(?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            sentencia.setDouble(9, cita.getDescuentototal());
...
//    }
    ...
    public List<Cita> listarCitas(LocalDate fecha) throws Exception {
        String consultaSQL = "select c.idcita,c.detallecita,c.fecha,c.preciocita,c.pagototal,c.tipocita,c.descuentototal,"
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Cita cita = new Cita(
                        ...
                        resultado.getDouble("descuentototal"));
                citas.add(cita);
            }
            return citas;
        } catch (Exception e) {
